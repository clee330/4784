...
% current with using step pulse
I(1:51) = 5; %5uA/cm^2 for 0.5ms, 51 because it start with 1.
I(52:numel(t)) = 0; % uA to make all the resting after 51.
...
axis([0, 100, -70.7, -67.5]) %Limit the axis
